...
const CLIENT_ORDER_COUNTS = [12, 9, 7, 6, 5, 5, 4, 4, 3, 3, 3, 2, 2, 2, 2, 1, 1, 1, 1, 1];
  ...
  indumentaria: {
    ...
    attributes: [
      ...
      },
      {
        id: 'material',
        name: 'Material',
        values: ['Algodón', 'Poliéster', 'Lino', 'Cuero', 'Denim', 'Lana'],
      },
    ],
    products: [
      {
        ...
        description:
          'Confeccionada en algodón Pima 180 g/m² con certificado GOTS. Costuras reforzadas, cuello canalé y lavados garantizados sin deformación. La base ideal para cualquier look.',
        categoryId: 'remeras',
        price: 8500,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Corte oversize con hombro caído y largo extendido. Tela jersey 220 g/m², efecto delavado suave. Ideal para combinar con joggers o jeans baggy.',
        categoryId: 'remeras',
        price: 10900,
        discount: 15,
      ...
      },
      {
        ...
        description:
          'Polo de tela piqué doble torsión 240 g/m². Cuello y puños acanalados, botones de nácar en frente. Corte slim fit que moldea sin apretar. Disponible en cinco colores clásicos.',
        categoryId: 'remeras',
        price: 15200,
        discount: 10,
      ...
      },
      {
        ...
        description:
          'Tejido térmico de doble cara (algodón exterior, poliéster termoaislante interior). Puños ajustados antipilling. La capa base perfecta para días fríos o actividades outdoor.',
        categoryId: 'remeras',
        price: 13800,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Serigrafía artesanal de cuatro colores sobre tela 100% algodón ring spun. Cada estampado es numerado. Diseños exclusivos de artistas locales en colaboración con nuestra tienda.',
        categoryId: 'remeras',
        price: 12400,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Corte recto amplio desde la cadera hasta el tobillo. Tela denim 380 g/m² de alta estabilidad. Versátil: queda bien con zapatillas, botas o mocasines.',
        categoryId: 'pantalones',
        price: 24800,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Interior de felpa de algodón 320 g/m², exterior liso antipilling. Pretina ancha con cordón plano, puños con elástico doble. Dos bolsillos laterales profundos y bolsillo trasero con cierre.',
        categoryId: 'pantalones',
        price: 18900,
        discount: 20,
      ...
      },
      {
        ...
        description:
          'Gabardina de algodón-elastano 260 g/m² con 4% stretch para mayor comodidad. Corte slim levemente cónico. Ideal para looks business casual o smart-casual. Cinco bolsillos.',
        categoryId: 'pantalones',
        price: 19500,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Tela ripstop 65/35 poliéster-algodón, resistente al desgarro y a la humedad. Seis bolsillos funcionales con cierre YKK. Pretina elástica trasera. El utilitario que no sacrifica el estilo.',
        categoryId: 'pantalones',
        price: 26500,
        discount: 10,
        image: u('1624378439575-d8705ad7ae80', 600, 600),
      ...
      },
      {
        ...
        description:
          'Mediasuela de espuma EVA + cámara de aire en talón y antepié. Upper de malla 3D ultraliviana con refuerzos de TPU. Suela de goma con canales multidireccionales. Peso: 285 g (talle 42).',
      ...
      },
      {
        ...
        description:
          'Upper de lona canvas 100% algodón con refuerzo en puntera. Suela vulcanizada clásica con textura cuadriculada. La base del armario urbano desde 1960. Disponible en 5 colores.',
        categoryId: 'zapatillas',
        price: 32000,
        discount: 15,
      ...
      },
      {
        ...
        description:
          'Reedición limitada inspirada en clásicos de los 90. Upper de cuero full grain + panel de nylon. Amortiguación con tecnología vintage foam. Logo bordado lateral. Caja de edición coleccionable.',
        categoryId: 'zapatillas',
        price: 58000,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Construida para HIIT, functional training y crossfit. Suela plana de 4 mm para máxima estabilidad en sentadillas. Upper de malla de ventilación zonal. Cordones planos preatados.',
        categoryId: 'zapatillas',
        price: 46000,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Plataforma de 4 cm en suela de goma inyectada. Upper de cuero sintético premium con costuras decorativas. El modelo favorito del streetwear contemporáneo. Sin cordones, cierre velcro oculto.',
        categoryId: 'zapatillas',
        price: 44000,
        discount: 25,
        image: u('1525966222134-fcfa99b8ae77', 600, 600),
      ...
      },
      {
        ...
        description:
          'Six-panel en twill de algodón 100%. Visera plana pre-curvada. Panel frontal con bordado 3D. Cierre snapback metálico ajustable talla única. Transpirabilidad garantizada por malla lateral.',
      ...
      },
      {
        ...
        description:
          'Cuerpo principal + bolsillo frontal con cierre YKK y organizador interior. Correa ajustable doble uso: cintura o bandolera. Tela ripstop resistente al agua con cremalleras plastificadas.',
        categoryId: 'accesorios',
        price: 9800,
        discount: 10,
      ...
      },
      {
        ...
        description:
          'Cuero full grain primera selección curtido al vegetal. Hebilla de zamak con acabado matte. Ancho 35 mm, largo ajustable hasta 120 cm. Incluye pasacinturón extra. Garantía de 3 años.',
        categoryId: 'accesorios',
        price: 14500,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Compartimento laptop hasta 16" con espuma protectora. Bolsa delantera organizada con 8 divisiones. Puerto USB integrado. Espalda ergonómica con malla 3D transpirable. Peso: 820 g.',
        categoryId: 'accesorios',
        price: 38000,
        discount: 0,
        image: u('1553062407-98eeb64c6a62', 600, 600),
      ...
      },
      {
        ...
        description:
          'Lentes polarizados CAT 3 con filtro UV400. Montura wayfarer de acetato italiano inyectado. Bisagras de primavera reforzadas. Incluye estuche rígido, paño microfibra y certificado de autenticidad.',
        categoryId: 'accesorios',
        price: 19500,
        discount: 20,
      ...
      },
      {
        ...
        description:
          'Membrana impermeabilizante 3.000 mm de presión hídrica. Costuras termoselladas. Empacable en su propio bolsillo trasero formando una pochette de 20×15 cm. Peso total: 340 g.',
        categoryId: 'camperas',
        price: 38000,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Cuero sintético PU de alta densidad con acabado matte. Forro de satín con bolsillos internos. Cierres metálicos YKK en diagonal, mangas y cuello. Hombros estructurados con padding.',
        categoryId: 'camperas',
        price: 72000,
        discount: 10,
      ...
      },
      {
        ...
        description:
          'Reversible: cara exterior en nylon ripstop, cara interior en satín naranja. Inspirada en el MA-1 original. Puños, cuello y dobladillo trenzados. Logo bordado en pecho. Icónica y atemporal.',
        categoryId: 'camperas',
        price: 45000,
        discount: 0,
      ...
      },
      {
        ...
        description:
          'Relleno de pluma sintética 600 fill power con tratamiento DWR (repelente al agua). Costuras de canalón para distribución uniforme del calor. Cremallera YKK doble tirador. Peso: 520 g.',
        categoryId: 'camperas',
        price: 62000,
        discount: 15,
      ...
      },
      {
        ...
        description:
          'Denim 14 oz lavado a la piedra con cuello, solapa y forro de sherpa de 300 g/m². Botones metálicos envejecidos. Bolsillos pecho y laterales funcionales. El clásico que nunca se va.',
        categoryId: 'camperas',
        price: 52000,
        discount: 0,
