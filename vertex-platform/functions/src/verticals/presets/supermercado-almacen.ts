...
export const SUPERMERCADO_ALMACEN_PRESET: BusinessVerticalDefinition = {
  ...
  featuredCategories: [
    { categoryId: 'almacen', name: 'Almacén & Secos', slug: 'almacen', imageUrl: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=600&h=400&fit=crop&q=80' },
    { categoryId: 'lacteos', name: 'Lácteos & Quesos', slug: 'lacteos', imageUrl: 'https://images.unsplash.com/photo-1550583724-b2692b85b150?w=600&h=400&fit=crop&q=80' },
    { categoryId: 'bebidas', name: 'Bebidas & Jugos', slug: 'bebidas', imageUrl: 'https://images.unsplash.com/photo-1527661591475-527312dd65f5?w=600&h=400&fit=crop&q=80' },
    { categoryId: 'limpieza', name: 'Limpieza del Hogar', slug: 'limpieza', imageUrl: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=600&h=400&fit=crop&q=80' },
  ],
  categories: [
    { id: 'almacen', name: 'Almacén, Pastas & Aceites', slug: 'almacen', order: 1, filterableAttributes: [] },
    { id: 'lacteos', name: 'Lácteos, Fiambres & Quesos', slug: 'lacteos', order: 2, filterableAttributes: [] },
    { id: 'bebidas', name: 'Bebidas, Aguas & Gaseosas', slug: 'bebidas', order: 3, filterableAttributes: ['volumen-bebida'] },
    { id: 'snacks', name: 'Snacks, Galletitas & Golosinas', slug: 'snacks', order: 4, filterableAttributes: [] },
    { id: 'limpieza', name: 'Limpieza & Cuidado del Hogar', slug: 'limpieza', order: 5, filterableAttributes: [] },
  ],
  attributes: [
  ...
  sampleProducts: [
    {
      ...
      stock: 45,
      skuPrefix: 'ALM-OLV',
      description: 'Aceite de oliva de acidez menor a 0.5% elaborado con olivas Arauco mendocinas en botella oscura.',
    ...
    },
    {
      ...
      stock: 50,
      skuPrefix: 'ALM-CAF',
      description: '100% arábica tostado artesanalmente con notas a caramelo y chocolate con leche.',
    ...
    },
    {
      ...
      stock: 90,
      skuPrefix: 'ALM-YRB',
      description: 'Estacionada 24 meses sin agroquímicos, bajo contenido de polvo y sabor suave duradero.',
    ...
    },
    {
      ...
      stock: 80,
      skuPrefix: 'ALM-FID',
      description: 'Elaborados con trefilado de bronce para una absorción óptima de salsas y textura al dente.',
    ...
    },
    {
      ...
      stock: 75,
      skuPrefix: 'ALM-ARR',
      description: 'Grano pulido de gran absorción ideal para risottos, paellas y comidas tradicionales.',
    ...
    },
    {
      ...
      stock: 60,
      skuPrefix: 'ALM-PAS',
      description: 'Tomates perita triturados madurados al sol sin conservantes artificiales en frasco de vidrio.',
      image: 'https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 40,
      skuPrefix: 'LAC-GOU',
      description: 'Queso de pasta semidura elaborado con leche entera de tambos locales con ojos regulares y sabor frutal.',
      image: 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 35,
      skuPrefix: 'LAC-JAM',
      description: 'Elaborado con pata de cerdo entera seleccionada, libre de gluten y con bajo contenido de sodio.',
    ...
    },
    {
      ...
      stock: 45,
      skuPrefix: 'LAC-YOG',
      description: 'Doble filtrado con alto contenido de proteínas naturales, sin azúcar añadida ni espesantes.',
      image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 55,
      skuPrefix: 'LAC-MNT',
      description: '100% crema de leche de primera calidad pasteurizada con sabor puro y untuosidad ideal.',
      image: 'https://images.unsplash.com/photo-1589985270826-4b7bb135bc9d?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1527661591475-527312dd65f5?w=800&h=800&fit=crop&q=80',
      hasVariants: true,
      variants: [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1613478223719-2ab802602423?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 80,
      skuPrefix: 'BEB-GAS',
      description: 'Bebida refrescante sabor cola con gasificación óptima para compartir en familia.',
      image: 'https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 65,
      skuPrefix: 'SNK-PAP',
      description: 'Papas seleccionadas fritas en aceite vegetal de girasol alto oleico con toque justo de sal marina.',
      image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 70,
      skuPrefix: 'SNK-CKI',
      description: 'Cookies horneadas con textura tierna y abundantes gotas de chocolate semiamargo.',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 35,
      skuPrefix: 'LMP-JAB',
      description: 'Remoción efectiva de manchas difíciles con fragancia floral de larga duración para 30 lavados.',
      image: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
      ...
      stock: 55,
      skuPrefix: 'LMP-MUL',
      description: 'Elimina el 99.9% de bacterias en mesadas, azulejos y pisos sin dejar residuos grasos.',
      image: 'https://images.unsplash.com/photo-1585421514738-01798e348b17?w=800&h=800&fit=crop&q=80',
      hasVariants: false,
    },
    {
