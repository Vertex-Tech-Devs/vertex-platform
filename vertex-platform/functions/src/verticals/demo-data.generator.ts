...
const RAW_CLIENTS = [
  {
    ...
    email: 'valenti.garcia@gmail.com',
    phone: '+54 9 11 4523-8801',
    city: 'CABA',
  ...
  },
  {
    ...
    phone: '+54 9 11 5634-9912',
    city: 'CABA',
    address: 'Av. Corrientes 4531, Almagro',
    daysAgoFirst: 60,
    daysAgoLast: 5,
    orders: 3,
    spent: 189000,
  },
  {
    ...
    phone: '+54 9 351 471-2334',
    city: 'Córdoba Capital',
    address: 'Bv. San Juan 840, Nueva Córdoba',
    daysAgoFirst: 45,
    daysAgoLast: 8,
    orders: 2,
    spent: 120000,
  },
  {
    ...
    phone: '+54 9 341 678-9220',
    city: 'Rosario',
    address: 'Bv. Oroño 1245, Centro',
    daysAgoFirst: 30,
    daysAgoLast: 1,
    orders: 2,
    spent: 98000,
  },
  {
    ...
    phone: '+54 9 261 554-1123',
    city: 'Mendoza',
    address: 'Av. San Martín 750, Godoy Cruz',
    daysAgoFirst: 25,
    daysAgoLast: 12,
    orders: 1,
    spent: 65000,
  },
  {
    ...
    email: 'agustin.morales@yahoo.com.ar',
    phone: '+54 9 221 489-0012',
    city: 'La Plata',
    address: 'Calle 7 N° 1120',
    daysAgoFirst: 20,
    daysAgoLast: 3,
    orders: 2,
    spent: 142000,
  ...
  {
    fullName: 'Joaquín Navarro',
    email: 'joaco.navarro@gmail.com',
    phone: '+54 9 11 6321-4455',
    city: 'San Isidro',
  ...
  return [
    {
      ...
      shippingAddress: {
        street: 'Av. Santa Fe 3421, Palermo',
        city: 'CABA',
        state: 'Buenos Aires',
        zip: '1425',
      },
    ...
    },
    {
      ...
      deliverySelection: {
        type: 'store_pickup',
        pickupAddressFormatted: 'Sucursal Central - Showroom Oficial',
      },
    },
    {
      id: `${storeId}-ORD-1003`,
    ...
    },
    {
      ...
      deliverySelection: {
        type: 'store_pickup',
        pickupAddressFormatted: 'Sucursal Mar del Plata - Güemes 2840',
      },
    },
    {
      id: `${storeId}-ORD-1008`,
