...
- **Bypass list**: Dejar vacío. _Ningún usuario o administrador debe saltarse las compuertas de seguridad en producción._
...
- **[x] Require linear history**: Exige que todos los commits de la PR se fusionen utilizando técnicas que dejen un historial plano y limpio (e.g., _Squash and merge_ o _Rebase and merge_). Se prohíben los _merge commits_ clásicos con bifurcaciones desordenadas.
...
3. Configura las siguientes opciones:
   ...
   - **Custom error message**: _"Mensaje de commit inválido. Por favor, utiliza el formato de Conventional Commits (e.g., 'feat(stores): add domain whitelisting support')."_
