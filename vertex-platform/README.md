...
1. **Instalar dependencias:**
   ...
   _(Nota: Se requiere `--legacy-peer-deps` debido a compatibilidad de paquetes en la versión de Angular)._
...
_Nota: Después de aplicar este script, el usuario afectado debe cerrar sesión y volver a iniciarla para refrescar sus tokens._
